...
import com.haruma.app.utility.NotificationHelper;
import com.haruma.app.utility.TaskScheduler;
...
public class AddViewModel extends BaseObservable {
    ...
    public void onAdd() {
        try {
            if (isValidInput()) {
                ...
                long newItemId = databaseHelper.addTimeTable(name, date, note, startTime, endTime, false, 0);
                ...
                if (newItemId != -1) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                        if (ContextCompat.checkSelfPermission(context, Manifest.permission.POST_NOTIFICATIONS) ==
                            ...
                            // Lên lịch thông báo
                            TaskScheduler.scheduleTaskNotifications(context, name, date, startTime, endTime);
                        }
                    } else {
                        // Đối với Android 12 trở xuống
                        TaskScheduler.scheduleTaskNotifications(context, name, date, startTime, endTime);
                    }
                }
    ...
    private boolean isValidTime(String time) {
        // Đúng định dạng HH:mm với giờ từ 00-23 và phút từ 00-59
