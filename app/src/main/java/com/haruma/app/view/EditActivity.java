...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Time pickers
        EditText edtStartTime = findViewById(R.id.start_time);
        EditText edtEndTime = findViewById(R.id.end_time);

        edtStartTime.setOnClickListener(v -> showTimePickerDialog(edtStartTime, editViewModel, true));
        edtEndTime.setOnClickListener(v -> showTimePickerDialog(edtEndTime, editViewModel, false));
    }



    //Đồng hồ
    private void showTimePickerDialog(EditText targetEditText, EditViewModel viewModel, boolean isStartTime) {
        String timeStr = isStartTime ? viewModel.getStartTime() : viewModel.getEndTime();
        int hour = 0;
        int minute = 0;
