...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long addTimeTable(String name, String day, String note, String startTime, String endTime, boolean status, int userId) {
    ...
    public boolean isEmailExists(String email) {
        ...
        Cursor cursor = db.query(
                TABLE_USER,                      // Bảng đúng là "User"
                new String[]{USER_EMAIL},       // Cột cần truy vấn
                USER_EMAIL + " = ?",            // Mệnh đề WHERE
                new String[]{email},            // Giá trị của dấu ? trong WHERE
                null, null, null
        );
        boolean exists = cursor.moveToFirst();  // true nếu tìm thấy ít nhất một dòng
        cursor.close();
        db.close();
        return exists;
    }
